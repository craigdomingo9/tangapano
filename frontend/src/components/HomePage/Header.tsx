    ...
    <div className="flex justify-center sticky z-50 top-0 p-4 h-24 text-white bg-[var(--ou-crimson)]">
      <div className="flex items-center justify-between w-full max-w-3xl px-1">
        <div>
          <Link
            href={"/"}
            className="font-bold scroll-m-20 text-2xl tracking-tighter"
          >
            TangaPano
          </Link>
          <p className="text-sm font-light leading-4">
            Secure your accommodation now!
          </p>
        </div>
        <div>
          {isAuthenticated && (
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={logout}
                className="underline underline-offset-2 cursor-pointer hover:scale-110 transition"
              >
