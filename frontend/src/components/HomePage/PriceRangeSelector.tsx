  ...
  return (
    <div className="space-y-4 shadow-2xl p-3 rounded-md">
      ...
      <div className="flex w-full">
        ...
        <div>
          <FormLabel className="font-semibold mx-2 justify-center">${minValue}</FormLabel>
        </div>
        ...
        <div className="relative h-5 w-[200px] mt-[-5px]">
          ...
          <div
            ref={progressRef}
            className="absolute top-1/2 h-[3px] pr-0 mr-0 bg-blue-500 -translate-y-1/2 z-0"
          />

          {/* Min range */}
          <Input
            className="absolute border-0 pl-0 pr-5 w-[200px] h-[30px] appearance-none bg-none z-10
              pointer-events-none
          ...
          {/* Max range */}
          <Input
            className="absolute border-0 pr-0 pl-5 w-[200px] h-[30px] appearance-none bg-none z-10
              pointer-events-none
              [&::-webkit-slider-thumb]:pointer-events-auto
              [&::-webkit-slider-thumb]:appearance-none
              [&::-webkit-slider-thumb]:h-[20px]
