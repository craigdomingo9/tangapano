...
function ListingCard({ listing }: Props) {
  ...
  return (
    <Card
      aria-label={`Listing: ${listing.title} in ${listing.neighborhood.name}`}
      className="py-0 mx-2 min-h-[34rem] w-[340px] flex flex-col gap-0 cursor-pointer hover:scale-[1.025] transition"
    >
