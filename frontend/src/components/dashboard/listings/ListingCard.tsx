      ...
      <Card className="py-0 mx-2 h-[34rem] flex flex-col gap-0 cursor-pointer hover:scale-[1.025] transition">
        ...
        <CardContent className="flex-1 px-3">
          <div className="[&>p]:text-sm">
            <h2 className="scroll-m-20 border-b pb-2 mb-2 text-lg font-semibold tracking-tight first:mt-0 truncate">{listing.title}</h2>
            <p className="text-gray-600 flex items-center mb-1">
              <MapPin size={16} className="mr-2 text-indigo-500" /> {listing.neighborhood.name}, {listing.neighborhood.city}
            </p>
