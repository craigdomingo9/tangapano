                    ...
                    <div key={emp.id} className="bg-card/40 backdrop-blur-xl border border-border/40 rounded-[2rem] p-6 shadow-sm active:bg-muted/30 transition-all relative overflow-hidden group">
                        ...
                        <div className="mt-6 space-y-3">
                            ...
                            <div className="space-y-2 px-1">
                                ...
                                <div className="flex items-center gap-3 text-xs font-semibold text-muted-foreground truncate">
                                ...
                                <tr key={emp.id} className="hover:bg-lapis/[0.02] transition-colors group">
                                    ...
                                    <td className="px-8 py-5">
                                        <div className="space-y-1.5">
                                            <span className="text-xs font-black text-foreground flex items-center gap-2 px-2.5 py-1 bg-muted/40 rounded-lg w-fit border border-border/20">
                                                <Building className="w-3.5 h-3.5 text-lapis" /> {emp.department?.name || "Unassigned"}
                                            </span>
                                            <span className="text-[10px] font-black text-lapis uppercase tracking-widest flex items-center gap-2 pl-2">
                                    ...
                                    <td className="px-8 py-5 text-muted-foreground font-black text-xs uppercase tracking-tighter tabular-nums whitespace-nowrap">
                                        {emp.date_hired || 'N/A'}
                                    </td>
