...
interface SuspendLandlordModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
export const SuspendLandlordModal: React.FC<SuspendLandlordModalProps> = ({
  isOpen,
  onClose,
  onConfirm,
  isSuspending,
  ...
  React.useEffect(() => {
    // console.log("[SuspendLandlordModal] isOpen:", isOpen);
    if (isOpen) {
            ...
            <div className="w-full py-4 px-4 flex flex-col items-center justify-center">
              ...
              <div className="flex gap-3 w-full justify-center">
                ...
                <button
                  onClick={onConfirm}
                  className={cn(
                    "px-6 py-2.5 text-sm rounded-lg bg-red-500 dark:bg-red-700 text-white font-bold hover:bg-red-500/70 dark:hover:bg-red-700/70 transition-colors shadow-sm cursor-pointer",
