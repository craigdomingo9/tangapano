...
function FullScreenListingMap({
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-white dark:bg-slate-950 animate-in fade-in duration-300 overflow-clip min-h-screen">
      {/* Header */}
      <div className="z-10 sticky top-0 flex items-center justify-between px-4 py-3 bg-crimson dark:bg-app-header backdrop-blur-md border-b border-slate-200 dark:border-slate-800 shadow-sm">
        <div>
