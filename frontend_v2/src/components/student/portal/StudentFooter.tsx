  ...
  return (
    <div className="mt-12 flex flex-col items-center gap-8">
      ...
      <div className="flex justify-center pb-6">
        <button className="text-slate-500 dark:text-slate-400 hover:text-crimson dark:hover:text-red-400 font-semibold text-sm flex items-center gap-2 transition-colors px-4 py-2 rounded-lg hover:bg-crimson/5 dark:hover:bg-red-900/20">
