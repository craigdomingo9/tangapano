declare global {
    ...
    type PermissionCodename =
        ...
        | 'view_landlord' | 'add_landlord' | 'change_landlord' | 'delete_landlord'
        | 'view_agent' | 'add_agent' | 'change_agent' | 'delete_agent'
        | 'view_listingstat' | 'add_listingstat' | 'change_listingstat' | 'delete_listingstat'
        | 'view_listingviewevent' | 'add_listingviewevent' | 'change_listingviewevent' | 'delete_listingviewevent'
        | 'view_usersession' | 'add_usersession' | 'change_usersession' | 'delete_usersession'
        | 'view_subscription' | 'add_subscription' | 'change_subscription' | 'delete_subscription'
        | 'view_tier' | 'add_tier' | 'change_tier' | 'delete_tier'
        | 'view_campus' | 'add_campus' | 'change_campus' | 'delete_campus'
        | 'view_city' | 'add_city' | 'change_city' | 'delete_city'
        | 'view_neighborhood' | 'add_neighborhood' | 'change_neighborhood' | 'delete_neighborhood'
        | 'view_interest' | 'add_interest' | 'change_interest' | 'delete_interest'
